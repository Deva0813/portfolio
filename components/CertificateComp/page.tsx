...
export const CertificateCardBig = (props: Props) => {
    return (
        ...
        <div className=' absolute top-[50%] left-[50%] -translate-y-1/2 -translate-x-1/2  w-min py-10 px-7 bg-[#e0e0e0] rounded-2xl drop-shadow-2xl shadow-2xl shadow-black/50 ' >
